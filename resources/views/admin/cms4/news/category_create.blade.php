                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                                <i data-feather="check" class="feather-14 mr-2 text-success"></i>
                                Think about your content structure
                            </li>
                            <li class="mb-2">
                                <i data-feather="check" class="feather-14 mr-2 text-success"></i>
                                Consider SEO-friendly slugs
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-2">
                                <i data-feather="info" class="feather-14 mr-2 text-warning"></i>
                                Category slugs must be unique
                            </li>
                            <li class="mb-2">
                                <i data-feather="info" class="feather-14 mr-2 text-warning"></i>
                                Inactive categories won't show in forms
                            </li>
                            <li class="mb-0">
                                <i data-feather="info" class="feather-14 mr-2 text-warning"></i>
                                Deleting categories affects articles
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        $(function() {
            ...
            $('form').on('submit', function(e) {
                ...
                // Show loading state
                $(this).find('button[type="submit"]').prop('disabled', true).html('<i data-feather="loader" class="feather-16 mr-2"></i> Creating...');
            });
