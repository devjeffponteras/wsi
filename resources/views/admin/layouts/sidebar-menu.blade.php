<ul class="nav nav-aside">
    ...
    <!-- <li class="nav-item with-sub @if (request()->routeIs('resources*') || request()->routeIs('resource-categories*')) active show @endif" style="@if(auth()->user()->role_id != '1') display: none; @endif">
        <a href="" class="nav-link"><i data-feather="edit"></i> <span>Cases</span></a>
        <ul>
            <li @if (\Route::current()->getName() == 'resources.index' || \Route::current()->getName() == 'resources.edit') class="active" @endif>
                <a href="{{ route('resources.index') }}">Manage Cases</a>
            </li>
            <li @if (\Route::current()->getName() == 'resources.create') class="active" @endif>
                <a href="{{ route('resources.create') }}">Create Cases</a>
            </li>
            <li @if (\Route::current()->getName() == 'resource-categories.index' || \Route::current()->getName() == 'resource-categories.edit') class="active" @endif>
                <a href="{{ route('resource-categories.index') }}">Manage Cases Status</a>
            </li>
            <li style="display: none;" @if (\Route::current()->getName() == 'resource-categories.create') class="active" @endif>
                <a href="{{ route('resource-categories.create') }}">Create a Category</a>
            </li>
        </ul>
    </li> -->
