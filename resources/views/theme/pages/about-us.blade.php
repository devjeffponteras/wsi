...
@section('content')
  ...
  {!! $content->contents !!}
    ...
    @include('theme.pages.partials.news-cta', [
        ...
        'ctaHeroClass' => 'cta-hero position-absolute'
    ])
    </div>
@endsection
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const enableCardToggles = window.matchMedia('(min-width: 641px)').matches;

    if (enableCardToggles) {
        ...
        serviceCards.forEach(card => card.classList.add('expanded'));
    }
